...
for i in range(10):
    ...
    for SEED in SEEDS:
        ...
        for i in range(len(result)):
            ...
            pathway_info = torch.as_tensor(non_pathway_info).to(device)
...
with open(ultimate_path + f"/reproduce/reproduction_scripts/tests/logs/test2/{task}/c_indices.txt", "w") as f:
