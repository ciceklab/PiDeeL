...
for SEED in SEEDS:
    ...
    for i in range(len(result)):
        ...
        model = Net(X_train.shape[1],10,pathway_info).to(device)
        ...
        for epoch in range(1, epochnum+1):
            ...
            loss = criterion(pred_probas, labels[0], labels[1],labels[2]) + l2_norm * l2_lambda
            ...
            with torch.no_grad():
                ...
                loss = criterion(pred_probas, labels_cv[0], labels_cv[1],labels_cv[2])+ l2_norm * l2_lambda
                vald_loss += loss.item()
