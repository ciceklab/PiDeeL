...
from load_targeted_data import predicted_quant, events, survival, full_spec
...
for SEED in SEEDS:
    ...
    for i in range(len(result)):
        X_train = full_spec[result[i][0]]
        X_test = full_spec[result[i][1]]
...
with open(f"../../../../test_logs/test27/{task}/c_indices.txt" ,"w") as f:
