...
for task in tasks:
    with open (f"../test_logs/test27/{task}/c_indices.txt", "r") as f:
        for lines in f:
            concordence[task].append(float(lines.strip()))
...
tasks = ["Full spectrum", "PiDeeL","Full spectrum", "PiDeeL", "Full spectrum", "PiDeeL"]
...
fig.savefig("suppfig6_full_spectrum.png")
fig.savefig("suppfig6_full_spectrum.pdf")
