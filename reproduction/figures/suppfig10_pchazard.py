...
for task in tasks:
    with open (REPO_ROOT / f"test_logs/test30/{task}/c_indices.txt", "r") as f:
        for lines in f:
            concordence[task].append(float(lines.strip()))
...
tasks = ["PC-Hazard", "PiDeeL","PC-Hazard", "PiDeeL", "PC-Hazard", "PiDeeL"]
...
fig.savefig("suppfig10_pchazard.png")
fig.savefig("suppfig10_pchazard.pdf")
