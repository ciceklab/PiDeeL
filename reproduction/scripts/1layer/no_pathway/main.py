...
for SEED in SEEDS:
    ...
    for i in range(len(result)):
        ...
        torch.save(model.state_dict(), f"/home/gunkaynar/targeted_survival/models/{task}/{SEED}_{i}net.pth")
        
with open(f"/home/gunkaynar/targeted_survival/logs/{task}/c_indices.txt" ,"w") as f:
